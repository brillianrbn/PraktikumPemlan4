...
public class Pekerja extends Manusia{
    ...
    public Pekerja(String nama, boolean jenisKelamin, String nik, boolean menikah, double gaji, int tahunMasuk, int bulanMasuk, int hariMasuk, int jumlahAnak) {
    ...
    public double getPendapatan() {
        return super.getTunjangan() + getBonus() + (jumlahAnak * 20); // Tunjangan + Bonus + Tunjangan Anak
    }
